      ...
      <el-submenu index="1">
        ...
        <el-menu-item-group>
          ...
          <el-submenu index="1-3">
              ...
              <el-menu-item index="1-3-4">选项4</el-menu-item>
          </el-submenu>
        ...
        <el-submenu index="2">
            ...
            <el-submenu index="2-3">
                ...
                <el-menu-item index="2-3-4">选项4</el-menu-item>
            </el-submenu>
            <el-submenu index="2-4">
                <template slot="title">选项4</template>
                <el-menu-item index="1-4-1">选项1</el-menu-item>
        ...
        <el-submenu index="3">
            ...
            <el-submenu index="3-3">
                ...
                <el-menu-item index="3-3-4">选项4</el-menu-item>
            </el-submenu>
            <el-submenu index="3-4">
                ...
                <el-menu-item index="3-4-4">选项4</el-menu-item>
            </el-submenu>
        </el-submenu>
    </el-menu>
  </el-col>
