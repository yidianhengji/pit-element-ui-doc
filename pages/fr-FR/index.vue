  ...
  <div>
    <div class="banner">
      <div class="banner-desc">
        <h1>Un kit de composants d'interface pour le web</h1>
        <p>Element, une bibliothèque de composants web basée sur Vue 2.0 pour les développeurs, designers et chef de produits.</p>
      </div>
    </div>
      ...
      <ul class="container">
        <li>
          <div class="card">
            ...
            <h3>Guide</h3>
            <p>Comprendre le design, aider les designers à concevoir un produit adapté, structuré et facile d'utilisation.</p>
            <router-link
              active-class="active"
              to="/fr-FR/guide/design"
              exact>Détails
            </router-link>
          </div>
        </li>
        <li>
          <div class="card">
            ...
            <h3>Composants</h3>
            <p>Découvrez les détails de chaque composant and parcourant les différentes démos. Utilisez l'encapsulation du code pour développer plus efficacement.</p>
            <router-link
              active-class="active"
              to="/fr-FR/component/layout"
              exact>Détails
            </router-link>
          </div>
        </li>
        ...
        <li>
          <div class="card">
            ...
            <h3>Ressources</h3>
            <p>Téléchargez différents outils de prototypage ou de visualisation pour un design plus efficace.</p>
            <router-link
              active-class="active"
              to="/fr-FR/resource"
              exact>Détails
