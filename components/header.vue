...
<!--    isHome-->
    <div id="v3-banner" v-if="false">
      <template v-if="lang === 'zh-CN'">
        您正在浏览基于 Vue 2.x 的 PitElement UI 文档;
      </template>
      <template v-else>
        You’re browsing the documentation of PitElement UI for Vue 2.x version.
      </template>
    </div>
    <header class="header" ref="header">
      <div class="container">
        ...
        <ul class="nav">
          ...
          <li class="nav-item" style="margin-left: 0px;" v-if="isShow">
            <a href="http://172.18.3.46:3000/document/jnpfFrame/component.html" target="_blank">业务组件库</a>
          </li>
<!--          <li class="nav-item" style="margin-left: 0px;">-->
<!--            <a href="https://493871850.gitee.io/document/jnpfFrame/component.html" target="_blank">业务组件库外网地址</a>-->
<!--          </li>-->
<!--          <li-->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      isShow() {
        return window.location.hostname === '172.18.3.46';
      }
    },
    // mounted() {
